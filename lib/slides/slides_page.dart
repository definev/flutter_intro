...
import '10_flutter_for_desktop/flutter_for_desktop_slide.dart';
import '11_flutter_for_toaster/flutter_for_toaster_slide.dart';
import '12_flutter_comparison/flutter_comparison_slide.dart';
import '13_dart/dart_slide.dart';
import '14_tooling/tooling_slide.dart';
import '15_integrations/integrations_slide.dart';
import '16_community/community_slide.dart';
import '17_drawbacks/drawbacks_slide.dart';
import '18_transition_to_flutter/transition_to_flutter_slide.dart';
import '19_future_of_flutter/future_of_flutter_slide.dart';
import '1_title/title_slide.dart';
import '20_thank_you/thank_you_slide.dart';
import '2_flutter_intro/flutter_intro_slide.dart';
import '3_flutter_concepts/flutter_concepts_slide.dart';
import '4_flutter_around_you/flutter_around_you_slide.dart';
import '5_custom_ui/custom_ui_slide.dart';
import '6_animations_rive/animations_rive_slide.dart';
import '7_flutter_for_dev/flutter_for_dev_slide.dart';
import '8_flutter_for_mobile/flutter_for_mobile_slide.dart';
import '9_flutter_for_web/flutter_for_web_slide.dart';
...
class _SlidesPageState extends State<SlidesPage> {
  ...
  void initState() {
    ...
    _shortcuts = <LogicalKeySet, Intent>{
      LogicalKeySet(LogicalKeyboardKey.alt, LogicalKeyboardKey.arrowLeft): const _HandleSlideIntent.arrowLeft(),
      LogicalKeySet(LogicalKeyboardKey.alt, LogicalKeyboardKey.arrowRight): const _HandleSlideIntent.arrowRight(),
    };
            ...
            child: PageView.builder(
              ...
              itemBuilder: (context, index) {
                switch (index) {
                  ...
                  case 7:
                    return const FlutterForDevSlide();
                  case 8:
